"""Where the Brine Urchin is fought: a flooded terrace, everything crusted with salt.
...
e.ground(SLATE, rim=STONE, dish=0.20)
e.apron(STONE, out=2.50, drop=0.60)
...
e.done(out_path(), name="BrineUrchinGround")
