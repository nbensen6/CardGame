"""Where the Gloom Moth is fought: rock the rift has bleached, and nothing grows.
...
e.ground(GRAPHITE, rim=CHARCOAL, dish=0.20)
...
e.done(out_path(), name="GloomMothGround")
