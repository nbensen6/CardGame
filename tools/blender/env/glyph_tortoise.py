"""Where the Glyph Tortoise is fought: a courtyard whose paving it has been wearing down.
...
e.ground(SAND, rim=TAN, dish=0.20)
e.apron(TAN, out=1.35, drop=0.60)
...
e.done(out_path(), name="GlyphTortoiseGround")
