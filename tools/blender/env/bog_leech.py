"""Where the Bog Leech is fought: standing water under the reeds.
...
e.ground(UMBER, rim=BROWN, dish=0.20)
e.apron(BROWN, out=2.50, drop=0.60)
...
e.done(out_path(), name="BogLeechGround")
